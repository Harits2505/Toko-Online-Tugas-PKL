    ...
    <div class="text-gray-900">
        <form action="" method="post">
            ...
            <div class="mb-2 w-25">
                ...
                <input type="text" name="size" value="" placeholder="P x L | Cth : 10CM x 5CM" class="form-control" id="formGroupExampleInput2" autocomplete="off" required>
            </div>
            ...
            <select class="form-select" name="tipe" aria-label="Default select example" required>
                <option value="Kartu" selected>Kartu</option>
            </select><br><br>
            ...
            <div class="mb-2 w-50">
                ...
                <input type="text" name="keterangan" placeholder="Cth : Kartu Pelajar" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off">
            </div>
            <hr class="sidebar-divider d-none d-md-block bg-gray-900">
