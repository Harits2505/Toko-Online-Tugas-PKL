    ...
    <div class="text-gray-900">
        ...
        <form action="" method="post">
            ...
            <div class="mb-2 w-25">
                ...
                <input type="text" name="size" value="" placeholder="P x L | Cth : 50CM x 50CM" class="form-control" id="formGroupExampleInput2" autocomplete="off" required>
            </div>
            ...
            <select class="form-select" name="tipe" aria-label="Default select example" required>
                ...
                <option value="Hiasan">Hiasan Akrilik</option>
            </select><br><br>
            ...
            <select class="form-select" name="bahan" aria-label="Default select example" required>
                <option value="Kaca Akrilik" selected>Kaca Akrilik</option>
            </select>
            ...
            <div class="mb-2 w-50">
                ...
                <input type="text" name="keterangan" placeholder="Cth : Plakat penghargaan" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off">
            </div>
