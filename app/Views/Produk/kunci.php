    ...
    <div class="text-gray-900">
        <form action="" method="post">
            ...
            <div class="mb-2 w-25">
                ...
                <input type="text" name="size" value="" placeholder="P x L | Cth : 5CM x 5CM" class="form-control" id="formGroupExampleInput2" autocomplete="off" required>
            </div>
            ...
            <select class="form-select" name="tipe" aria-label="Default select example" required>
                <option value="Gantungan Kunci" selected>Gantungan Kunci</option>
            </select><br><br>
            ...
            <select class="form-select" name="bahan" aria-label="Default select example" required>
                ...
                <option value="Kaca Akrilik">Kaca Akrilik</option>
            </select>
            <br><br>
            <div class="mb-2 w-50">
            ...
            <div class="mb-2 w-50">
                ...
                <input type="text" name="keterangan" placeholder="Cth : Gantungan kunci hadiah" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off">
            </div>
            <hr class="sidebar-divider d-none d-md-block bg-gray-900">
