    ...
    <div class="text-gray-900">
        <form action="" method="post">
            ...
            <select class="form-select" name="bahan" aria-label="Default select example" required>
                ...
                <option value="Standard Mug">Standard Mug</option>
            </select>
            <br><br>
            <div class="mb-2 w-50">
            ...
            <div class="mb-2 w-50">
                ...
                <input type="text" name="keterangan" placeholder="Cth : Mug hadiah" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off">
            </div>
            <hr class="sidebar-divider d-none d-md-block bg-gray-900">
