    ...
    <div class="text-gray-900">
        <form action="" method="post">
            ...
            <div class="mb-2 w-25">
                ...
                <i class="text-danger">*Panjang badan x Lebar badan (CM)</i>
                <input type="text" name="size" value="" placeholder="P x L | Cth : 50CM x 70CM" class="form-control" id="formGroupExampleInput2" autocomplete="off" required>
            </div>
            ...
            <select class="form-select" name="bahan" aria-label="Default select example" required>
                ...
                <option value="Kain Drifit">Kain Drifit</option>
                <option value="Drifit Mtiis">Drifit Mtiis</option>
                <option value="Drifit Nike">Drifit Nike</option>
            </select>
            <br><br>
            <div class="mb-2 w-50">
                <label for="formGroupExampleInput2" class="form-label">Jumlah</label><br>
                <input type="text" name="jumlah" placeholder="Cth : 5 Pcs" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off" required>
            </div>
            <div class="mb-2 w-50">
                <label for="formGroupExampleInput2" class="form-label">Keterangan</label><br>
                <input type="text" name="keterangan" placeholder="Cth : Jersey bola" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off">
            </div>
            <hr class="sidebar-divider d-none d-md-block bg-gray-900">
