    ...
    <div class="text-gray-900">
        <form action="" method="post" >
            ...
            <div class="mb-2 w-25">
                ...
                <input type="text" name="size" value="" placeholder="P x L | Cth : 1M x 2M" class="form-control" id="formGroupExampleInput2" autocomplete="off" required>
            </div>
            ...
            <select class="form-select" name="opsi" aria-label="Default select example" required>
                ...
                <option value="Lebah">Lebah</option>
                <option value="Kantung">Kantung</option>
            </select><br><br>
            ...
            <div class="mb-2 w-50">
                ...
                <input type="text" name="keterangan" placeholder="Cth : Banner bagi-bagi takjil" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off">
            </div>
            <hr class="sidebar-divider d-none d-md-block bg-gray-900">
