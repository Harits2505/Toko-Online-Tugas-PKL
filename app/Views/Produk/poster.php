    ...
    <div class="text-gray-900">
        <form action="" method="post">
            ...
            <div class="mb-2 w-25">
                ...
                <input type="text" name="size" value="" placeholder="P x L | Cth : 20CM x 20CM" class="form-control" id="formGroupExampleInput2" autocomplete="off" required>
            </div>
            ...
            <div class="mb-2 w-50">
                ...
                <input type="text" name="keterangan" placeholder="Cth : Poster/Brosur promosi" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off">
            </div>
            <hr class="sidebar-divider d-none d-md-block bg-gray-900">
