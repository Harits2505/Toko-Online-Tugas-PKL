    ...
    <div class="text-gray-900">
        <form action="" method="post">
            ...
            <div class="mb-2 w-25">
                ...
                <input type="text" name="size" value="" placeholder="P x L | Cth : 15CM x 10CM" class="form-control" id="formGroupExampleInput2" autocomplete="off" required>
            </div>
            <label for="formGroupExampleInput2" class="form-label">Pilih Opsi</label><br>
            <select class="form-select" name="opsi" aria-label="Default select example">
                <option selected>Pilih Opsi Laminasi</option>
            ...
            <select class="form-select" name="bahan" aria-label="Default select example" required>
                ...
                <option value="Bontax">Bontax</option>
            ...
            <div class="mb-2 w-50">
                ...
                <input type="text" name="keterangan" placeholder="Cth : Sticker Label Makanan" value="" class="form-control" id="formGroupExampleInput2" autocomplete="off">
            </div>
            <hr class="sidebar-divider d-none d-md-block bg-gray-900">
...
mysqli_query($koneksi, "insert into pesanan set
     ...
     ?></center><br>
            <center><button type="submit" value="simpan" name="proses" class="btn btn-primary w-50">Konfirmasi</button></center>
        </form>
    </div>
    <?= $this->endSection(); ?>