...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'phonenumber'         => ['type' => 'varchar', 'constraint' => 15, 'null' => true],
            ...
            'carousel_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'photo.svg'],
            ...
            'banner_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'banner.jpg'],
            'sticker_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'sticker.jpg'],
            'tshirt_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'tshirt.jpg'],
            'jersey_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'jersey.jpg'],
            'mug_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'mug.jpg'],
            'poster_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'poster.jpg'],
            'kunci_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'kunci.jpg'],
            'sertifikat_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'sertifikat.jpg'],
            'kartu_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'kartu.jpg'],
            'tumbler_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'tumbler.jpg'],
            'akrilik_image'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'akrilik.jpg'],
            'facebook'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'facebook.png'],
            'instagram'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'instagram.png'],
            'whatsapp'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'whatsapp.png'],
            'messenger'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'messenger.png'],
            'youtube'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'youtube.png'],
            'tiktok'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'tiktok.png'],
            'github'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'github.png'],
            'cod'       => ['type' => 'varchar', 'constraint' => 255, 'default' => 'Cod.png'],
            'namapengguna'         => ['type' => 'varchar', 'constraint' => 255, 'null' => true],
        ]);
